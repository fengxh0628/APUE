...
int main(int argc, char *argv[])
{
...
#ifdef ATEXIT_MAX
	printf("AREXIT_MAX defined to be %ld\n", (long)ATEXIT_MAX);
#else
...
#ifdef _SC_CLK_TCK
	pr_sysconf("CLF_TCK = ", _SC_CLK_TCK);
#else
...
#else
	printf("no symbol for LIME_MAX\n");
#endif
#ifdef _SC_LINE_MAX
	printf("LINE_MAX = ", _SC_LINE_MAX);
#else
	...
	pr_sysconf("SEM_NSMES_MAX = ", _SC_SEM_NSEMS_MAX);
#else
	...
	printf("_POSIX_TIMESTRAMP_RESILUTION defined to be %ld\n", (long)_POSIX_TIMESTAMP_RESOLUTION + 0);
#else
